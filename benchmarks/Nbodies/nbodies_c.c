...
static void Body_Offset_Momentum(struct Body *b, double px, double py,
                                 double pz) {
  b->vx = -px / solar_mass;
  b->vy = -py / solar_mass;
  b->vz = -pz / solar_mass;
...
int main(int argc, char **argv) {
  ...
  struct Body jupiter = (struct Body){4.84143144246472090e+00,
  ...
  struct Body neptune = (struct Body){1.53796971148509165e+01,
  ...
  size_t nbodies = 5;
  struct Body *bodies = (struct Body[5]){jupiter, saturn, uranus, neptune, sun};
