...
static void Body_Offset_Momentum(struct Body *self, double px, double py,
                                 double pz) {
...
int main(int argc, char **argv) {
  ...
  var jupiter =
      $(Body, 4.84143144246472090e+00, -1.16032004402742839e+00,
        -1.03622044471123109e-00, days_per_year * 1.66007664274403694e-03,
  ...
  var saturn =
      $(Body, 8.34336671824457987e+00, 4.12479856412430479e+00,
        -4.03523417114321381e-01, days_per_year * -2.76742510726862411e-03,
  ...
  var uranus =
      $(Body, 1.28943695621391310e+01, -1.51111514016986312e+01,
        -2.23307578892655734e-01, days_per_year * 2.96460137564761618e-03,
  ...
  var neptune =
      $(Body, 1.53796971148509165e+01, -2.59193146099879641e+01,
        1.79258772950371181e-01, days_per_year * 2.68067772490389322e-03,
  ...
  var bodies = new (Array, Body, jupiter, saturn, uranus, neptune, sun);
