...
PT_FUNC(test_array_get) {
  ...
  var a1 = new (Array, String, $S("Hello"), $S("There"), $S("People"));
...
PT_FUNC(test_array_iter) {
  ...
  a0 = new (Array, String, $S("Hello"), $S("There"), $S("People"));
  ...
  foreach (item in a0) {
    ...
    switch (counter) {
    case 0:
      PT_ASSERT(eq(item, $S("Hello")));
      break;
    case 1:
      PT_ASSERT(eq(item, $S("There")));
      break;
    case 2:
      PT_ASSERT(eq(item, $S("People")));
      break;
    }
...
var greater_than_two(var x) { return c_int(x) > 2 ? x : NULL; }

var mem_hello(var x) { return mem(x, $S("Hello")) ? x : NULL; }
...
var return_fst(var args) { return get(args, $I(0)); }

var return_snd(var args) { return get(args, $I(1)); }
...
PT_SUITE(suite_function) { PT_REG(test_function_call); }
...
PT_FUNC(test_list_get) {
  ...
  var l1 = new (List, String, $S("Hello"), $S("There"), $S("People"));
...
PT_FUNC(test_list_iter) {
  ...
  l0 = new (List, String, $S("Hello"), $S("There"), $S("People"));
...
PT_FUNC(test_mutex_lock) {
  ...
  var threads = new (Array, Box, new (Thread, $(Function, increment)),
...
PT_FUNC(test_mutex_start) {
  ...
  var threads = new (Array, Box, new (Thread, $(Function, increment2)),
...
PT_FUNC(test_table_assign) {
  ...
  var t1 =
      new (Table, String, Int, $S("asfa"), $I(0), $S("gasg"), $I(2), $S("asda"),
           $I(1), $S("dqga"), $I(0), $S("jaja"), $I(7), $S("sdfa"), $I(2),
...
PT_FUNC(test_table_cmp) {
  ...
  var t0 = new (Table, String, Int, $S("Hello"), $I(2), $S("There"), $I(5));

  var t1 = new (Table, String, Int, $S("Hello"), $I(2), $S("There"), $I(5));

  var t2 = new (Table, String, Int, $S("Bello"), $I(2), $S("There"), $I(5));

  var t3 = new (Table, String, Int, $S("Hello"), $I(2), $S("There"), $I(5),
                $S("World"), $I(6));
...
PT_FUNC(test_table_get) {
  ...
  var t3 = new (Table, String, Int, $S("asfa"), $I(0), $S("gasg"), $I(2),
                $S("asda"), $I(1), $S("dqga"), $I(0), $S("jaja"), $I(7),
                $S("sdfa"), $I(2), $S("jads"), $I(7), $S("kyad"), $I(2),
                $S("kyas"), $I(7), $S("hwdw"), $I(2), $S("oaqv"), $I(7),
                $S("fgds"), $I(2), $S("awaa"), $I(7), $S("lkil"), $I(2));
...
PT_FUNC(test_thread_cmp) { PT_ASSERT(eq(current(Thread), current(Thread))); }
...
PT_FUNC(test_tree_assign) {
  ...
  var m1 =
      new (Tree, String, Int, $S("asfa"), $I(0), $S("gasg"), $I(2), $S("asda"),
           $I(1), $S("dqga"), $I(0), $S("jaja"), $I(7), $S("sdfa"), $I(2),
           $S("jads"), $I(7), $S("kyad"), $I(2), $S("kyas"), $I(7), $S("hwdw"),
           $I(2), $S("awaa"), $I(7), $S("lkil"), $I(2));
...
PT_FUNC(test_tree_cmp) {
  ...
  var m0 = new (Tree, String, Int, $S("Hello"), $I(2), $S("There"), $I(5));

  var m1 = new (Tree, String, Int, $S("Hello"), $I(2), $S("There"), $I(5));

  var m2 = new (Tree, String, Int, $S("Bello"), $I(2), $S("There"), $I(5));

  var m3 = new (Table, String, Int, $S("Hello"), $I(2), $S("There"), $I(5),
                $S("World"), $I(6));
...
PT_FUNC(test_tree_get) {
  ...
  var m3 = new (Tree, String, Int, $S("asfa"), $I(0), $S("gasg"), $I(2),
                $S("asda"), $I(1), $S("dqga"), $I(0), $S("jaja"), $I(7),
                $S("sdfa"), $I(2), $S("jads"), $I(7), $S("kyad"), $I(2),
                $S("kyas"), $I(7), $S("hwdw"), $I(2), $S("oaqv"), $I(7),
                $S("fgds"), $I(2), $S("awaa"), $I(7), $S("lkil"), $I(2));
...
PT_FUNC(test_type_new) {
  ...
  TestType = new_root(Type, $S("TestType"), $I(sizeof(struct TestType)),
                      $(New, TestType_New, NULL), $(Cmp, TestType_Cmp));
